class_name Scenario29
extends Scenario01

## S29 — Run-up curve: set run_up_m export; harness runs 20/60/120/200.

const TRACE_PREFIX := "scenario_29"
...
func _write_trace_file() -> void:
	...
	print("[Scenario 29] Trace written: %s" % file_path)
